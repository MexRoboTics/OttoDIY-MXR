...
#define PIN_YL 4 //servo[0] connect Servo Hip left to D4
#define PIN_YR 5 //servo[1] Connect Servo Hip right to D5
#define PIN_RL 6 //servo[2] Connect Servo Foot Left to D6
#define PIN_RR 7 //servo[3] COnnect Servo Foot Right to D7
...
#define BT_Rx   0//6 //6  0
#define BT_Tx   1//7 //7  1
//define Max7219 pins 
#define PIN_DIN    10   //max 7219
#define PIN_CS     11
#define PIN_CLK    12
//define buttons Mode Action Otto
#define PIN_SecondButton 2
#define PIN_ThirdButton 3
