...
//----------------------------------------------------------------
//-- Otto basic firmware v2 based on Zowi basic firmware v2
...
//--
//-- Contributor: Rafael Adrian Garcia Garcia
//-----------------------------------------------------------------
//-- Experiment with all the features that Otto have!
//-----------------------------------------------------------------
//Hardware conection Pins: Arduino Nano 
//HC05   Tx  ----> Rx (0) Arduino D6
//       Rx  ----> Tx (1) Arduino D7
//SoundSensor         (A2 16) this is due (A6) is exclusive analogue
//Ultrasensor Echo    (D9)
...
//PIN_CS              (D11)
//PIN_CLK             (D12)
//PIN_SecondButton    (A4 18)
//PIN_ThirdButton     (A5 19)
...
//---Otto Buttons original dos 6 tres 7
...
const char programID[]="Otto_base_v2"; //Each program will have a ID
...
byte moveId=0;            //Number of movement
byte moveSize=15;         //Asociated with the height of some movements
...
void setup(){
  ...
  //Set the servo pins
  Otto.init(PIN_YL,PIN_YR,PIN_RL,PIN_RR,false,7,17,8,9);
  ledmatrix.init();
...
delay(500); //Wait for possible noise of the servos while get home
        ...
        if (Otto.getNoised()>= 1){ //740 // this is due my sensor is digital, if your sensor is analoge use only Otto.getNoise()>= 650
