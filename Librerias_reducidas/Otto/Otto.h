...
class Otto
{
  public:
    ...
    //-- Otto initialization
    void init(byte YL, byte YR, byte RL, byte RR, bool load_calibration=true, byte NoiseSensor=PIN_NoiseSensor, byte Buzzer=PIN_Buzzer, byte USTrigger=PIN_Trigger, byte USEcho=PIN_Echo);
